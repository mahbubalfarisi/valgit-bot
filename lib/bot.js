...
client.on('messageCreate', async message => {
    ...
    // PULL AND PUSH COMMAND
        ...
        try {
            ...
            if (command === 'pull') {
                ...
                message.channel.send(`Git pull triggered at branch ${branch}, Last pull by: ${userTag}`);
            }
            // PUSH COMMAND
                ...
                message.channel.send(`Successfully pushed to branch ${branch}, Last push by: ${userTag}`);
            }
        }
        catch (error) {
    ...
    // HELP COMMAND
        ...
        let return_data = `$help : Show all the avaailable commands.\n`;
